...
<xsl:stylesheet
  ...
  <xsl:variable name="lang.invoice">Commercial Invoice</xsl:variable>
  ...
  <xsl:variable name="lang.shipping">Shipping</xsl:variable>
  <xsl:variable name="lang.handling">Handling</xsl:variable>
  <xsl:variable name="lang.shippingHandling">Shipping and Handling</xsl:variable>
  <xsl:variable name="lang.taxAmount">Tax</xsl:variable>
  <xsl:variable name="lang.total">Total</xsl:variable>
  <xsl:variable name="lang.businessNumber">Company Registration Number</xsl:variable>
