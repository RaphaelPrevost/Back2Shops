...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rate.applies_to_personal_accounts'
        db.add_column(u'taxes_rate', 'applies_to_personal_accounts',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rate.applies_to_business_accounts'
        db.add_column(u'taxes_rate', 'applies_to_business_accounts',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rate.applies_to_personal_accounts'
        db.delete_column(u'taxes_rate', 'applies_to_personal_accounts')

        # Deleting field 'Rate.applies_to_business_accounts'
        db.delete_column(u'taxes_rate', 'applies_to_business_accounts')
