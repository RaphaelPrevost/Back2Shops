...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategoryTypeMap'
        db.create_table(u'sales_categorytypemap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.ProductCategory'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.ProductType'])),
        ))
        db.send_create_signal(u'sales', ['CategoryTypeMap'])

        # Deleting field 'ProductType.category'
        db.delete_column(u'sales_producttype', 'category_id')


    def backwards(self, orm):
        # Deleting model 'CategoryTypeMap'
        db.delete_table(u'sales_categorytypemap')

        # Adding field 'ProductType.category'
        db.add_column(u'sales_producttype', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sales.ProductCategory']),
                      keep_default=False)
