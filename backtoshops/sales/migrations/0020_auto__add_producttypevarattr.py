...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductTypeVarAttr'
        db.create_table(u'sales_producttypevarattr', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sale', self.gf('django.db.models.fields.related.ForeignKey')(related_name='type_varattrs', to=orm['sales.Sale'])),
            ('attr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attributes.VariableAttribute'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'sales', ['ProductTypeVarAttr'])


    def backwards(self, orm):
        # Deleting model 'ProductTypeVarAttr'
        db.delete_table(u'sales_producttypevarattr')
