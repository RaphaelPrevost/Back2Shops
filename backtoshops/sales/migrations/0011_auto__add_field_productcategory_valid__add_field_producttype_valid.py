...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.valid'
        db.add_column(u'sales_productcategory', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProductType.valid'
        db.add_column(u'sales_producttype', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductCategory.valid'
        db.delete_column(u'sales_productcategory', 'valid')

        # Deleting field 'ProductType.valid'
        db.delete_column(u'sales_producttype', 'valid')
