...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductPicture.sort_order'
        db.add_column(u'sales_productpicture', 'sort_order',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductPicture.sort_order'
        db.delete_column(u'sales_productpicture', 'sort_order')
