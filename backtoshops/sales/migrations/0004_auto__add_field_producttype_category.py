...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sales_producttype', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sales.ProductCategory']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductType.category'
        db.delete_column('sales_producttype', 'category_id')
