...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderConfirmSetting'
        db.create_table(u'sales_orderconfirmsetting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('require_confirm', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sale', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orderconfirmsettings', to=orm['sales.Sale'])),
            ('brand_attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attributes.BrandAttribute'], null=True, blank=True)),
            ('common_attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attributes.CommonAttribute'], null=True, blank=True)),
        ))
        db.send_create_signal(u'sales', ['OrderConfirmSetting'])


    def backwards(self, orm):
        # Deleting model 'OrderConfirmSetting'
        db.delete_table(u'sales_orderconfirmsetting')
