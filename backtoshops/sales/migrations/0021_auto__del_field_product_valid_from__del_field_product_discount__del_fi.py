...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.valid_from'
        db.delete_column(u'sales_product', 'valid_from')

        # Deleting field 'Product.discount'
        db.delete_column(u'sales_product', 'discount')

        # Deleting field 'Product.discount_type'
        db.delete_column(u'sales_product', 'discount_type')

        # Deleting field 'Product.valid_to'
        db.delete_column(u'sales_product', 'valid_to')

        # Adding field 'Product.available_from'
        db.add_column(u'sales_product', 'available_from',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Product.available_to'
        db.add_column(u'sales_product', 'available_to',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.valid_from'
        db.add_column(u'sales_product', 'valid_from',
                      self.gf('django.db.models.fields.DateField')(default='datetime.datetime.now'),
                      keep_default=False)

        # Adding field 'Product.discount'
        db.add_column(u'sales_product', 'discount',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'Product.discount_type'
        db.add_column(u'sales_product', 'discount_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'Product.valid_to'
        db.add_column(u'sales_product', 'valid_to',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Deleting field 'Product.available_from'
        db.delete_column(u'sales_product', 'available_from')

        # Deleting field 'Product.available_to'
        db.delete_column(u'sales_product', 'available_to')
    ...
    models = {
        ...
        u'attributes.variableattribute': {
            'Meta': {'object_name': 'VariableAttribute'},
            'for_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'variable_attributes'", 'to': u"orm['sales.ProductType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'valid': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        ...
        u'sales.categorytypemap': {
            'Meta': {'object_name': 'CategoryTypeMap'},
        ...
        u'sales.externalref': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sale': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'externalrefs'", 'to': u"orm['sales.Sale']"})
        },
        u'sales.orderconfirmsetting': {
            'Meta': {'object_name': 'OrderConfirmSetting'},
            'brand_attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['attributes.BrandAttribute']", 'null': 'True', 'blank': 'True'}),
            'common_attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['attributes.CommonAttribute']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'require_confirm': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sale': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orderconfirmsettings'", 'to': u"orm['sales.Sale']"})
        },
        u'sales.product': {
            'Meta': {'object_name': 'Product'},
            'available_from': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'available_to': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            ...
            'short_description': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'}),
        ...
        u'sales.producttypevarattr': {
            'Meta': {'object_name': 'ProductTypeVarAttr'},
            'attr': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['attributes.VariableAttribute']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sale': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'type_varattrs'", 'to': u"orm['sales.Sale']"}),
