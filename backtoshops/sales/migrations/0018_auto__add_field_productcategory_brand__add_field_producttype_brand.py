...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.brand'
        db.add_column(u'sales_productcategory', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Brand'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductType.brand'
        db.add_column(u'sales_producttype', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Brand'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductCategory.brand'
        db.delete_column(u'sales_productcategory', 'brand_id')

        # Deleting field 'ProductType.brand'
        db.delete_column(u'sales_producttype', 'brand_id')
