...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.is_default'
        db.add_column(u'sales_productcategory', 'is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProductType.is_default'
        db.add_column(u'sales_producttype', 'is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        db.execute("insert into sales_productcategory(name, valid, is_default) values('Unspecified', true, true)")
        db.execute("insert into sales_producttype(name, valid, is_default) values('Unspecified', true, true)")


    def backwards(self, orm):
        db.execute("update sales_productcategory set valid = false where is_default true")
        db.execute("update sales_producttype set valid = false where is_default true")

        # Deleting field 'ProductCategory.is_default'
        db.delete_column(u'sales_productcategory', 'is_default')

        # Deleting field 'ProductType.is_default'
        db.delete_column(u'sales_producttype', 'is_default')
