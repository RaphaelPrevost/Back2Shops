...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BoughtHistory'
        db.create_table(u'stats_boughthistory', (
        ...
        db.send_create_signal(u'stats', ['BoughtHistory'])


    def backwards(self, orm):
        # Deleting model 'BoughtHistory'
        db.delete_table(u'stats_boughthistory')
