...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('barcodes_barcode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upc', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sale', self.gf('django.db.models.fields.related.ForeignKey')(related_name='barcodes', to=orm['sales.Sale'])),
        ...
        db.send_create_signal('barcodes', ['Barcode'])


    def backwards(self, orm):
        
        # Deleting model 'Barcode'
        db.delete_table('barcodes_barcode')
