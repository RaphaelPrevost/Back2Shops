...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VariableAttribute'
        db.create_table(u'attributes_variableattribute', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('for_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='variable_attributes', to=orm['sales.ProductType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('valid', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'attributes', ['VariableAttribute'])


    def backwards(self, orm):
        # Deleting model 'VariableAttribute'
        db.delete_table(u'attributes_variableattribute')
