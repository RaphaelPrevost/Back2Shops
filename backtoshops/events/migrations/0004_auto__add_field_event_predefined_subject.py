...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.predefined_subject'
        db.add_column(u'events_event', 'predefined_subject',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.predefined_subject'
        db.delete_column(u'events_event', 'predefined_subject')
