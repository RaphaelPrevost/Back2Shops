...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'address_address', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Address.zipcode'
        db.alter_column(u'address_address', 'zipcode', self.gf('django.db.models.fields.IntegerField')(null=True))
